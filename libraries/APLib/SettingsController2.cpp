...
namespace APLib {
	int SettingsController2::drawPage() {
		_tftPtr->fillScreen(GREEN);
	...
	int SettingsController2::mapUserCmd(TSPoint* p, char* ctrToRequestBuf) {
	...
	int SettingsController2::index(void) {
