...
#define FIRST_PIN 0   // Ð¿ÐµÑ€Ð²Ñ‹Ð¹ Ð²Ñ‹Ð²Ð¾Ð´
#define LAST_PIN 53   // Ð¿Ð¾Ñ�Ð»ÐµÐ´Ð½Ð¸Ð¹ Ð²Ñ‹Ð²Ð¾Ð´
...
void loop() {
  if (Serial.available() > 0) {
    switch (Serial.read()) {
      case 'a': // Ð¢ÐµÑ�Ñ‚ Ñ�Ð²ÐµÑ‚Ð¾Ð´Ð¸Ð¾Ð´Ð¾Ð¼
        Serial.print(F("\nBlink test:"));
      ...
      case 'b':
        ...
        displayHelp();
      break;
      case 'c': // Ð¢ÐµÑ�Ñ‚ Ð½Ð° ÐºÐ¾Ñ€Ð¾Ñ‚ÐºÐ¾Ðµ Ð·Ð°Ð¼Ñ‹ÐºÐ°Ð½Ð¸Ðµ Ð²Ñ‹Ð²Ð¾Ð´Ð¾Ð²
